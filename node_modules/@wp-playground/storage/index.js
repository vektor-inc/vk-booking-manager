import { Semaphore as ar, normalizePath as St, joinPaths as sr } from "@php-wasm/util";
...
const cr = new ar({ concurrency: 10 });
async function Ue(n, t, e, r, o) {
  const c = await cr.acquire();
  try {
...
function mn(n) {
  ...
  for (; e < n.length; ) {
    ...
    c === "40000" && (c = "040000");
    const f = pr(c), s = n.slice(r + 1, o).toString("utf8");
...
function vn(n) {
  return !n.oid && n.sha && (n.oid = n.sha), n.mode = bn(n.mode), n.type || (n.type = pr(n.mode)), n;
}
class ue {
  constructor(t) {
...
var Tn = ie.exports, oe = { exports: {} }, le = {}, Ft = {};
Ft.byteLength = Dn;
Ft.toByteArray = Cn;
Ft.fromByteArray = Ln;
var W = [], L = [], On = typeof Uint8Array < "u" ? Uint8Array : Array, Tt = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var Z = 0, Rn = Tt.length; Z < Rn; ++Z)
...
function Cn(n) {
  var t, e = yr(n), r = e[0], o = e[1], c = new On(jn(n, r, o)), f = 0, s = o > 0 ? r - 4 : r, h;
  for (h = 0; h < s; h += 4)
...
function Mn(n, t, e) {
  for (var r, o = [], c = t; c < e; c += 3)
    r = (n[c] << 16 & 16711680) + (n[c + 1] << 8 & 65280) + (n[c + 2] & 255), o.push(Nn(r));
  return o.join("");
}
function Ln(n) {
 ...
 */
(function(n) {
  var t = Ft, e = he, r = typeof Symbol == "function" && typeof Symbol.for == "function" ? Symbol.for("nodejs.util.inspect.custom") : null;
  ...
  function Mr(u, i, a, l) {
    return gt(Kr(i), u, a, l);
  }
  function Lr(u, i, a, l) {
    return gt(Se(i), u, a, l);
  }
  function Gr(u, i, a, l) {
    return gt(Zr(i, u.length - a), u, a, l);
  }
  ...
  function Xr(u) {
    if (u = u.split("=")[0], u = u.trim().replace(Yr, ""), u.length < 2) return "";
    for (; u.length % 4 !== 0; )
      u = u + "=";
    return u;
  }
...
var pe = oe.exports, Gn = {}.toString, qn = Array.isArray || function(n) {
  return Gn.call(n) == "[object Array]";
}, lt = TypeError, wr = Object, Hn = Error, zn = EvalError, Wn = RangeError, Vn = ReferenceError, gr = SyntaxError, Jn = URIError, Yn = Math.abs, Xn = Math.floor, Kn = Math.max, Zn = Math.min, Qn = Math.pow, ti = Math.round, ei = Number.isNaN || function(t) {
  return t !== t;
}, ri = ei, ni = function(t) {
...
function oi() {
  if (De) return Rt;
  De = 1;
  var n = typeof Symbol < "u" && Symbol, t = mr();
  return Rt = function() {
...
var Dt, je;
function br() {
  return je || (je = 1, Dt = typeof Reflect < "u" && Reflect.getPrototypeOf || null), Dt;
}
var jt, Ce;
function vr() {
  if (Ce) return jt;
...
var ai = "Function.prototype.bind called on incompatible ", si = Object.prototype.toString, ci = Math.max, fi = "[object Function]", Ne = function(t, e) {
  ...
  return o;
}, pi = hi, pt = Function.prototype.bind || pi, de = Function.prototype.call, ye = Function.prototype.apply, di = typeof Reflect < "u" && Reflect && Reflect.apply, yi = pt, wi = ye, gi = de, mi = di, Er = mi || yi.call(gi, wi), bi = pt, vi = lt, Ei = de, xi = Er, we = function(t) {
...
function Ai() {
  ...
  return Ct = r && typeof r.get == "function" ? n([r.get]) : typeof c == "function" ? (
    /** @type {import('./get')} */
    function(s) {
...
var A, Si = wr, Fi = Hn, Ii = zn, _i = Wn, $i = Vn, rt = gr, et = lt, Ui = Jn, Pi = Yn, ki = Xn, Ti = Kn, Oi = Zn, Ri = Qn, Di = ti, ji = ni, Ar = Function, Lt = function(n) {
  try {
    return Ar('"use strict"; return (' + n + ").constructor;")();
  } catch {
  }
}, at = ht, Ci = It, Gt = function() {
  throw new et();
}, Ni = at ? function() {
  try {
...
}() : Gt, Q = oi()(), R = xr(), Mi = vr(), Li = br(), Br = ye, dt = de, tt = {}, Gi = typeof Uint8Array > "u" || !R ? A : R(Uint8Array), Y = {
  __proto__: null,
...
var Hi = function n(t) {
...
}, yt = pt, xt = Bi(), zi = yt.call(dt, Array.prototype.concat), Wi = yt.call(Br, Array.prototype.splice), He = yt.call(dt, String.prototype.replace), At = yt.call(dt, String.prototype.slice), Vi = yt.call(dt, RegExp.prototype.exec), Ji = /[^%.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|%$))/g, Yi = /\\(\\)?/g, Xi = function(t) {
  ...
  return s;
}, Fr = Sr, Ir = we, Zi = Ir([Fr("%String.prototype.indexOf%")]), _r = function(t, e) {
  var r = (
    /** @type {(this: unknown, ...args: unknown[]) => unknown} */
    Fr(t, !!e)
  );
  return typeof r == "function" && Zi(t, ".prototype.") > -1 ? Ir(
    /** @type {const} */
    [r]
  ) : r;
}, qt, ze;
...
function ro() {
  if (Je) return Wt;
  Je = 1;
  var n = eo(), t = typeof globalThis > "u" ? dr : globalThis;
  return Wt = function() {
...
function oo() {
  if (Ke) return Xt;
  Ke = 1;
  var n = Sr, t = no(), e = io()(), r = ht, o = lt, c = n("%Math.floor%");
...
function fo() {
  if (er) return Qt;
  er = 1;
  var n = to(), t = ro(), e = so(), r = _r, o = ht, c = xr(), f = r("Object.prototype.toString"), s = co()(), h = typeof globalThis > "u" ? dr : globalThis, y = t(), d = r("String.prototype.slice"), w = r("Array.prototype.indexOf", !0) || function(B, x) {
...
var lo = lt, ho = _r, po = ho("TypedArray.prototype.buffer", !0), yo = uo(), wo = po || function(t) {
  if (!yo(t))
...
}, vo = typeof Uint8Array < "u", $r = typeof ArrayBuffer < "u" && typeof Uint8Array < "u", Eo = $r && (G.prototype instanceof Uint8Array || G.TYPED_ARRAY_SUPPORT), xo = function(t, e) {
  if (G.isBuffer(t))
...
var So = _t, Fo = Tn, Ur = So, Io = pe.Buffer, _o = [
  1518500249,
  1859775393,
  -1894007588,
  -899497514
...
function wt() {
  this.init(), this._w = $o, Ur.call(this, 64, 56);
}
Fo(wt, Ur);
...
let ee = null;
async function Bt(n) {
  return ee === null && (ee = await Co()), ee ? Pr(n) : jo(n);
}
function jo(n) {
...
async function Co() {
  try {
    if (await Pr(new Uint8Array([])) === "da39a3ee5e6b4b0d3255bfef95601890afd80709") return !0;
  } catch {
  }
  return !1;
}
...
class J {
  ...
  get entries() {
    return [...this._entries.values()].sort(hr);
  }
  get entriesMap() {
    return this._entries;
  }
...
async function xa(n, t, e, r) {
  const o = (r == null ? void 0 : r.additionalHeaders) || {}, c = await Rr(
    n,
    t,
    o
...
`)
  ...
  const c = jr(o.body), f = await Tr(c), s = Buffer.from(await ct(f.packfile)), h = await nt.fromPack({
    pack: s
  }), y = h.read;
...
`)
  ...
  const c = jr(o.body), f = await Tr(c), s = Buffer.from(await ct(f.packfile));
...
export {
  Pa as ChrootFilesystem,
  $a as EventedFilesystem,
  Ta as FetchFilesystem,
  ge as GitAuthenticationError,
  Ua as InMemoryFilesystem,
  Ra as InMemoryFilesystemBackend,
  Oa as NodeJsFilesystem,
  ce as OpfsFilesystemBackend,
  ka as OverlayFilesystem,
  se as ZipFilesystem,
  ba as changeset,

...
return array(
    ...
    'VKBookingManager\\Admin\\Pro_Upsell' => $baseDir . '/src/admin/class-pro-upsell.php',
    'VKBookingManager\\Admin\\Provider_Settings_Page' => $baseDir . '/src/admin/class-provider-settings-page.php',
    'VKBookingManager\\Admin\\Service_Menu_Editor' => $baseDir . '/src/admin/class-service-menu-editor.php',
    'VKBookingManager\\Admin\\Setup_Notices' => $baseDir . '/src/admin/class-setup-notices.php',
    'VKBookingManager\\Admin\\Shift_Dashboard_Page' => $baseDir . '/src/admin/class-shift-dashboard-page.php',
    'VKBookingManager\\Admin\\Style_Guide_Page' => $baseDir . '/src/admin/class-style-guide-page.php',
    'VKBookingManager\\Admin\\User_Profile_Fields' => $baseDir . '/src/admin/class-user-profile-fields.php',
    'VKBookingManager\\Assets\\Common_Styles' => $baseDir . '/src/assets/class-common-styles.php',
    'VKBookingManager\\Auth\\Auth_Shortcodes' => $baseDir . '/src/auth/class-auth-shortcodes.php',
    'VKBookingManager\\Availability\\Availability_Booking_Cache_Generation' => $baseDir . '/src/availability/class-availability-booking-cache-generation.php',
    'VKBookingManager\\Availability\\Availability_Cache_Generation' => $baseDir . '/src/availability/class-availability-cache-generation.php',
    'VKBookingManager\\Availability\\Availability_Service' => $baseDir . '/src/availability/class-availability-service.php',
    'VKBookingManager\\Blocks\\Block_Category' => $baseDir . '/src/blocks/class-block-category.php',
    'VKBookingManager\\Blocks\\Menu_Card_Block' => $baseDir . '/src/blocks/class-menu-card-block.php',
    'VKBookingManager\\Blocks\\Menu_Loop_Block' => $baseDir . '/src/blocks/class-menu-loop-block.php',
    'VKBookingManager\\Blocks\\Menu_Search_Block' => $baseDir . '/src/blocks/class-menu-search-block.php',
    'VKBookingManager\\Blocks\\Reservation_Block' => $baseDir . '/src/blocks/class-reservation-block.php',
    'VKBookingManager\\Blocks\\Reservation_Button_Block' => $baseDir . '/src/blocks/class-reservation-button-block.php',
    'VKBookingManager\\Blocks\\Reservation_Button_Renderer' => $baseDir . '/src/blocks/shared/class-reservation-button-renderer.php',
    'VKBookingManager\\Bookings\\Booking_Admin' => $baseDir . '/src/bookings/class-booking-admin.php',
    'VKBookingManager\\Bookings\\Booking_Confirmation_Controller' => $baseDir . '/src/bookings/class-booking-confirmation-controller.php',
    'VKBookingManager\\Bookings\\Booking_Draft_Controller' => $baseDir . '/src/bookings/class-booking-draft-controller.php',
    'VKBookingManager\\Bookings\\My_Bookings_Controller' => $baseDir . '/src/bookings/class-my-bookings-controller.php',
    'VKBookingManager\\Bookings\\User_Favorites_Controller' => $baseDir . '/src/bookings/class-user-favorites-controller.php',
    'VKBookingManager\\Capabilities\\Capabilities' => $baseDir . '/src/capabilities/class-capabilities.php',
    'VKBookingManager\\Capabilities\\Roles_Manager' => $baseDir . '/src/capabilities/class-roles-manager.php',
    'VKBookingManager\\Common\\Exclusive_Fee' => $baseDir . '/src/common/class-exclusive-fee.php',
    'VKBookingManager\\Common\\Nomination_Min_Guests_Message' => $baseDir . '/src/common/class-nomination-min-guests-message.php',
    'VKBookingManager\\Common\\Price_Tiers' => $baseDir . '/src/common/class-price-tiers.php',
    'VKBookingManager\\Common\\Rate_Limit_Trait' => $baseDir . '/src/common/trait-rate-limit.php',
    'VKBookingManager\\Common\\Reservation_Day' => $baseDir . '/src/common/class-reservation-day.php',
    'VKBookingManager\\Common\\Resource_Tag_Id_List' => $baseDir . '/src/common/class-resource-tag-id-list.php',
    'VKBookingManager\\Common\\Staff_Load_Calculator' => $baseDir . '/src/common/class-staff-load-calculator.php',
    'VKBookingManager\\Common\\VKBM_Helper' => $baseDir . '/src/common/class-vkbm-helpers.php',
    'VKBookingManager\\Common\\Weekday_Rule' => $baseDir . '/src/common/class-weekday-rule.php',
    'VKBookingManager\\Notifications\\Booking_Notification_Service' => $baseDir . '/src/notifications/class-booking-notification-service.php',
    'VKBookingManager\\OEmbed\\OEmbed_Override' => $baseDir . '/src/oembed/class-oembed-override.php',
    'VKBookingManager\\Plugin' => $baseDir . '/src/class-plugin.php',
    'VKBookingManager\\PostOrder\\Post_Order_Manager' => $baseDir . '/src/post-order/class-post-order-manager.php',
    'VKBookingManager\\PostTypes\\Booking_Post_Type' => $baseDir . '/src/post-types/class-booking-post-type.php',
    'VKBookingManager\\PostTypes\\Resource_Post_Type' => $baseDir . '/src/post-types/class-resource-post-type.php',
    'VKBookingManager\\PostTypes\\Service_Menu_Post_Type' => $baseDir . '/src/post-types/class-service-menu-post-type.php',
    'VKBookingManager\\PostTypes\\Shift_Post_Type' => $baseDir . '/src/post-types/class-shift-post-type.php',
    'VKBookingManager\\ProviderSettings\\Industry_Presets' => $baseDir . '/src/provider-settings/class-industry-presets.php',
    'VKBookingManager\\ProviderSettings\\Settings_Repository' => $baseDir . '/src/provider-settings/class-settings-repository.php',
    'VKBookingManager\\ProviderSettings\\Settings_Sanitizer' => $baseDir . '/src/provider-settings/class-settings-sanitizer.php',
    'VKBookingManager\\ProviderSettings\\Settings_Service' => $baseDir . '/src/provider-settings/class-settings-service.php',
    'VKBookingManager\\REST\\Auth_Form_Controller' => $baseDir . '/src/rest/class-auth-form-controller.php',
    'VKBookingManager\\REST\\Availability_Controller' => $baseDir . '/src/rest/class-availability-controller.php',
    'VKBookingManager\\REST\\Current_User_Controller' => $baseDir . '/src/rest/class-current-user-controller.php',
    'VKBookingManager\\REST\\Menu_Preview_Controller' => $baseDir . '/src/rest/class-menu-preview-controller.php',
    'VKBookingManager\\REST\\Provider_Settings_Controller' => $baseDir . '/src/rest/class-provider-settings-controller.php',
    'VKBookingManager\\Resources\\Resource_Schedule_Meta_Box' => $baseDir . '/src/resources/class-resource-schedule-meta-box.php',
    'VKBookingManager\\Resources\\Resource_Schedule_Template_Repository' => $baseDir . '/src/resources/class-resource-schedule-template-repository.php',
    'VKBookingManager\\Resources\\Resource_Tag_Taxonomy' => $baseDir . '/src/resources/class-resource-tag-taxonomy.php',
    'VKBookingManager\\Shifts\\Shift_Editor' => $baseDir . '/src/shifts/class-shift-editor.php',
    'VKBookingManager\\Staff\\Staff_Editor' => $baseDir . '/src/staff/class-staff-editor.php',
    ...
    'VKBookingManager\\Tests\\Admin\\Pro_Upsell_Test' => $baseDir . '/tests/phpunit/admin/test-pro-upsell.php',
    'VKBookingManager\\Tests\\Admin\\Provider_Settings_Page_Radius_Display_Test' => $baseDir . '/tests/phpunit/admin/test-provider-settings-page-radius-display.php',
    'VKBookingManager\\Tests\\Admin\\Service_Menu_Editor_Basic_Settings_Anchor_Link_Test' => $baseDir . '/tests/phpunit/admin/test-service-menu-editor-basic-settings-anchor-link.php',
    'VKBookingManager\\Tests\\Admin\\Service_Menu_Editor_Exclusive_Mutual_Exclusion_Test' => $baseDir . '/tests/phpunit/admin/test-service-menu-editor-exclusive-mutual-exclusion.php',
    'VKBookingManager\\Tests\\Admin\\Service_Menu_Editor_Exclusive_When_Booked_Persistence_Test' => $baseDir . '/tests/phpunit/admin/test-service-menu-editor-exclusive-when-booked-persistence.php',
    'VKBookingManager\\Tests\\Admin\\Service_Menu_Editor_Nomination_Min_Guests_Label_Test' => $baseDir . '/tests/phpunit/admin/test-service-menu-editor-nomination-min-guests-label.php',
    'VKBookingManager\\Tests\\Admin\\Service_Menu_Editor_Nomination_Toggle_Test' => $baseDir . '/tests/phpunit/admin/test-service-menu-editor-nomination-toggle.php',
    'VKBookingManager\\Tests\\Admin\\Service_Menu_Editor_Price_Input_Width_Test' => $baseDir . '/tests/phpunit/admin/test-service-menu-editor-price-input-width.php',
    'VKBookingManager\\Tests\\Admin\\Service_Menu_Editor_Rendering_Order_Test' => $baseDir . '/tests/phpunit/admin/test-service-menu-editor-rendering-order.php',
    ...
    'VKBookingManager\\Tests\\Admin\\Shift_Dashboard_Min_Capacity_Test' => $baseDir . '/tests/phpunit/admin/test-shift-dashboard-min-capacity.php',
    'VKBookingManager\\Tests\\Admin\\Shift_Dashboard_Sprintf_Test' => $baseDir . '/tests/phpunit/admin/test-shift-dashboard-sprintf.php',
    'VKBookingManager\\Tests\\Assets\\Block_Style_Tokens_Test' => $baseDir . '/tests/phpunit/assets/test-block-style-tokens.php',
    ...
    'VKBookingManager\\Tests\\Availability\\Availability_Booking_Cache_Generation_Test' => $baseDir . '/tests/phpunit/availability/test-availability-booking-cache-generation.php',
    'VKBookingManager\\Tests\\Availability\\Availability_Cache_Generation_Test' => $baseDir . '/tests/phpunit/availability/test-availability-cache-generation.php',
    ...
    'VKBookingManager\\Tests\\Availability\\Exclusive_Booking_Test' => $baseDir . '/tests/phpunit/availability/test-exclusive-booking.php',
    'VKBookingManager\\Tests\\Availability\\Get_Unavailability_Reason_Test' => $baseDir . '/tests/phpunit/availability/test-get-unavailability-reason.php',
    'VKBookingManager\\Tests\\Availability\\Is_Date_Allowed_For_Menu_Test' => $baseDir . '/tests/phpunit/availability/test-is-date-allowed-for-menu.php',
    'VKBookingManager\\Tests\\Availability\\Resource_Tag_Filter_Test' => $baseDir . '/tests/phpunit/availability/test-resource-tag-filter.php',
    'VKBookingManager\\Tests\\Bookings\\Availability_Service_Args_Recording_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-double-availability-service-args-recording.php',
    'VKBookingManager\\Tests\\Bookings\\Availability_Service_Error_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-booking-confirmation-controller.php',
    ...
    'VKBookingManager\\Tests\\Bookings\\Booking_Admin_Email_Sanitize_Test' => $baseDir . '/tests/phpunit/bookings/test-booking-admin-email-sanitize.php',
    'VKBookingManager\\Tests\\Bookings\\Booking_Admin_Guests_Test' => $baseDir . '/tests/phpunit/bookings/test-booking-admin-guests.php',
    'VKBookingManager\\Tests\\Bookings\\Booking_Admin_Resource_Notice_Test' => $baseDir . '/tests/phpunit/bookings/test-booking-admin-resource-notice.php',
    ...
    'VKBookingManager\\Tests\\Bookings\\Booking_Resource_Tag_Confirmation_Test' => $baseDir . '/tests/phpunit/bookings/test-booking-resource-tag-confirmation.php',
    'VKBookingManager\\Tests\\Bookings\\Booking_Resource_Tag_Passthrough_Test' => $baseDir . '/tests/phpunit/bookings/test-booking-resource-tag-passthrough.php',
    'VKBookingManager\\Tests\\Bookings\\Exclusive_Availability_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-exclusive-booking-controllers.php',
    'VKBookingManager\\Tests\\Bookings\\Exclusive_Booking_Controllers_Test' => $baseDir . '/tests/phpunit/bookings/test-exclusive-booking-controllers.php',
    'VKBookingManager\\Tests\\Bookings\\Exclusive_Conflict_Availability_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-exclusive-when-booked-blocks-user-selectable.php',
    'VKBookingManager\\Tests\\Bookings\\Exclusive_Conflict_Notification_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-exclusive-when-booked-blocks-user-selectable.php',
    'VKBookingManager\\Tests\\Bookings\\Exclusive_Notification_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-exclusive-booking-controllers.php',
    'VKBookingManager\\Tests\\Bookings\\Exclusive_When_Booked_Blocks_User_Selectable_Test' => $baseDir . '/tests/phpunit/bookings/test-exclusive-when-booked-blocks-user-selectable.php',
    'VKBookingManager\\Tests\\Bookings\\Is_Reservation_Day_Allowed_Test' => $baseDir . '/tests/phpunit/bookings/test-is-reservation-day-allowed.php',
    'VKBookingManager\\Tests\\Bookings\\Max_Capacity_Availability_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-max-capacity-disables-multi-guest-settings.php',
    'VKBookingManager\\Tests\\Bookings\\Max_Capacity_Disables_Multi_Guest_Settings_Test' => $baseDir . '/tests/phpunit/bookings/test-max-capacity-disables-multi-guest-settings.php',
    'VKBookingManager\\Tests\\Bookings\\Max_Capacity_Notification_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-max-capacity-disables-multi-guest-settings.php',
    'VKBookingManager\\Tests\\Bookings\\My_Bookings_Controller_Test' => $baseDir . '/tests/phpunit/bookings/test-my-bookings-controller.php',
    'VKBookingManager\\Tests\\Bookings\\Nomination_Exclusive_Availability_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-nomination-staff-scoped-exclusive-booking.php',
    'VKBookingManager\\Tests\\Bookings\\Nomination_Exclusive_Notification_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-nomination-staff-scoped-exclusive-booking.php',
    'VKBookingManager\\Tests\\Bookings\\Nomination_Staff_Scoped_Exclusive_Booking_Test' => $baseDir . '/tests/phpunit/bookings/test-nomination-staff-scoped-exclusive-booking.php',
    'VKBookingManager\\Tests\\Bookings\\Staff_Distribution_Test' => $baseDir . '/tests/phpunit/bookings/test-staff-distribution.php',
    'VKBookingManager\\Tests\\Bookings\\User_Exclusive_Availability_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-user-exclusive-booking.php',
    'VKBookingManager\\Tests\\Bookings\\User_Exclusive_Booking_Test' => $baseDir . '/tests/phpunit/bookings/test-user-exclusive-booking.php',
    'VKBookingManager\\Tests\\Bookings\\User_Exclusive_Notification_Test_Double' => $baseDir . '/tests/phpunit/bookings/test-user-exclusive-booking.php',
    'VKBookingManager\\Tests\\Bookings\\User_Favorites_Controller_Test' => $baseDir . '/tests/phpunit/bookings/test-user-favorites-controller.php',
    ...
    'VKBookingManager\\Tests\\Common\\Exclusive_Fee_Test' => $baseDir . '/tests/phpunit/common/test-exclusive-fee.php',
    'VKBookingManager\\Tests\\Common\\Get_Staff_Display_Name_Test' => $baseDir . '/tests/phpunit/common/test-get-staff-display-name.php',
    'VKBookingManager\\Tests\\Common\\Guests_Label_Helpers_Test' => $baseDir . '/tests/phpunit/common/test-guests-label-helpers.php',
    ...
    'VKBookingManager\\Tests\\Common\\Min_Capacity_Status_Test' => $baseDir . '/tests/phpunit/common/test-min-capacity-status.php',
    'VKBookingManager\\Tests\\Common\\Price_Tiers_Test' => $baseDir . '/tests/phpunit/common/test-price-tiers.php',
    'VKBookingManager\\Tests\\Common\\Rate_Limit_Trait_Stub' => $baseDir . '/tests/phpunit/common/test-rate-limit-trait.php',
    'VKBookingManager\\Tests\\Common\\Rate_Limit_Trait_Test' => $baseDir . '/tests/phpunit/common/test-rate-limit-trait.php',
    'VKBookingManager\\Tests\\Common\\Reservation_Day_Test' => $baseDir . '/tests/phpunit/common/test-reservation-day.php',
    'VKBookingManager\\Tests\\Common\\Resource_Tag_Id_List_Test' => $baseDir . '/tests/phpunit/common/test-resource-tag-id-list.php',
    'VKBookingManager\\Tests\\Common\\VKBM_Helper_Get_User_Display_Name_Test' => $baseDir . '/tests/phpunit/common/test-vkbm-helper-get-user-display-name.php',
    'VKBookingManager\\Tests\\Common\\VKBM_Helper_Remove_Img_Auto_Sizes_Test' => $baseDir . '/tests/phpunit/common/test-vkbm-helper-remove-img-auto-sizes.php',
    'VKBookingManager\\Tests\\Common\\Weekday_Rule_Test' => $baseDir . '/tests/phpunit/common/test-weekday-rule.php',
    'VKBookingManager\\Tests\\Frontend\\Menu_Loop_Card_Image_Sizes_Test' => $baseDir . '/tests/phpunit/rendering/test-menu-loop-card-image-sizes.php',
    'VKBookingManager\\Tests\\Frontend\\Menu_Loop_Card_Min_Capacity_Test' => $baseDir . '/tests/phpunit/rendering/test-menu-loop-card-min-capacity.php',
    'VKBookingManager\\Tests\\Frontend\\Menu_Loop_Card_Nomination_Gating_Test' => $baseDir . '/tests/phpunit/rendering/test-menu-loop-card-nomination-gating.php',
    'VKBookingManager\\Tests\\Frontend\\Menu_Loop_Card_Price_Tiers_Test' => $baseDir . '/tests/phpunit/rendering/test-menu-loop-card-price-tiers.php',
    'VKBookingManager\\Tests\\Frontend\\Menu_Loop_Card_Reservation_Day_Test' => $baseDir . '/tests/phpunit/rendering/test-menu-loop-card-reservation-day.php',
    'VKBookingManager\\Tests\\Frontend\\Menu_Loop_Card_Start_Time_Test' => $baseDir . '/tests/phpunit/rendering/test-menu-loop-card-start-time.php',
    'VKBookingManager\\Tests\\Frontend\\Menu_Loop_Selection_List_Staff_Filter_Test' => $baseDir . '/tests/phpunit/rendering/test-menu-loop-selection-list-staff-filter.php',
    'VKBookingManager\\Tests\\Frontend\\Menu_Loop_Selection_List_Tag_Filter_Test' => $baseDir . '/tests/phpunit/rendering/test-menu-loop-selection-list-tag-filter.php',
    ...
    'VKBookingManager\\Tests\\Frontend\\Reservation_Button_Renderer_Test' => $baseDir . '/tests/phpunit/rendering/test-reservation-button-renderer.php',
    ...
    'VKBookingManager\\Tests\\PostTypes\\Resource_Post_Type_Menu_Icon_Test' => $baseDir . '/tests/phpunit/post-types/test-resource-post-type-menu-icon.php',
    'VKBookingManager\\Tests\\PostTypes\\Service_Menu_Allow_Multiple_Guests_Auth_Test' => $baseDir . '/tests/phpunit/post-types/test-service-menu-allow-multiple-guests-auth.php',
    'VKBookingManager\\Tests\\PostTypes\\Service_Menu_Disable_Nomination_Auth_Test' => $baseDir . '/tests/phpunit/post-types/test-service-menu-disable-nomination-auth.php',
    ...
    'VKBookingManager\\Tests\\PostTypes\\Service_Menu_Min_Capacity_Auth_Test' => $baseDir . '/tests/phpunit/post-types/test-service-menu-min-capacity-auth.php',
    'VKBookingManager\\Tests\\PostTypes\\Service_Menu_Nomination_Min_Guests_Rest_Field_Test' => $baseDir . '/tests/phpunit/post-types/test-service-menu-nomination-min-guests-rest-field.php',
    'VKBookingManager\\Tests\\PostTypes\\Service_Menu_Price_Tiers_Auth_Test' => $baseDir . '/tests/phpunit/post-types/test-service-menu-price-tiers-auth.php',
    'VKBookingManager\\Tests\\PostTypes\\Service_Menu_Quick_Edit_Basic_Settings_Anchor_Link_Test' => $baseDir . '/tests/phpunit/post-types/test-service-menu-quick-edit-basic-settings-anchor-link.php',
    'VKBookingManager\\Tests\\PostTypes\\Service_Menu_Revisions_Test' => $baseDir . '/tests/phpunit/post-types/test-service-menu-revisions.php',
    'VKBookingManager\\Tests\\ProviderSettings\\Industry_Presets_Test' => $baseDir . '/tests/phpunit/provider-settings/test-industry-presets.php',
    ...
    'VKBookingManager\\Tests\\ProviderSettings\\Settings_Sanitizer_Guests_Unit_Test' => $baseDir . '/tests/phpunit/provider-settings/test-settings-sanitizer-guests-unit.php',
    ...
    'VKBookingManager\\Tests\\REST\\Availability_Controller_Permissions_Test' => $baseDir . '/tests/phpunit/rest/test-availability-controller-permissions.php',
    'VKBookingManager\\Tests\\REST\\Menu_Preview_Controller_Menu_Loop_Staff_Filter_Test' => $baseDir . '/tests/phpunit/rest/test-menu-preview-controller-menu-loop-staff-filter.php',
    'VKBookingManager\\Tests\\REST\\Provider_Settings_Controller_Menu_Display_Test' => $baseDir . '/tests/phpunit/rest/test-provider-settings-controller-menu-display.php',
    'VKBookingManager\\Tests\\Resources\\Resource_Menu_Icon_Test' => $baseDir . '/tests/phpunit/resources/test-resource-menu-icon.php',
    'VKBookingManager\\Tests\\Resources\\Resource_Tag_Filter_Helpers_Test' => $baseDir . '/tests/phpunit/resources/test-resource-tag-filter-helpers.php',
    'VKBookingManager\\Tests\\Staff\\Staff_Editor_Free_Source_Test' => $baseDir . '/tests/phpunit/staff/test-staff-editor-free-source.php',
    'VKBookingManager\\Tests\\Staff\\Staff_Editor_Multi_Guest_And_Exclusive_Booking_Gates_Test' => $baseDir . '/tests/phpunit/staff/test-staff-editor-multi-guest-and-exclusive-booking-gates.php',
    'VKBookingManager\\Tests\\Staff\\Staff_Editor_Nomination_For_Menu_Test' => $baseDir . '/tests/phpunit/staff/test-staff-editor-nomination-for-menu.php',
);
